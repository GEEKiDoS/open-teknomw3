...
namespace scheduler
{
	...
	public:
		...
		void post_load() override
		{
			...
			{
				r_end_frame_hook.create(0x5B54D2, scheduler::r_end_frame_stub);
			}
			
			utils::hook::call(SELECT_VALUE(0x543B0E, 0), scheduler::main_frame_stub);
			utils::hook::call(SELECT_VALUE(0x5F0156, 0), scheduler::server_frame_stub);
		}
