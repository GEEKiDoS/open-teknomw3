...
namespace console
{
	...
	public:
		...
		void post_load() override
		{
			...
			utils::hook::jump(SELECT_VALUE(0x446930, 0), append_text);
	...
	HWND get_window()
	{
		return *reinterpret_cast<HWND*>((SELECT_VALUE(0x5A86330, 0)));
	}
	...
	void set_size(const int width, const int height)
	{
		...
		auto* const logo_window = *reinterpret_cast<HWND*>(SELECT_VALUE(0x5A86338, 0));
