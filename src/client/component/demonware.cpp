...
#pragma warning(pop)
	...
	public:
		component()
		{
			udp_servers.create<stun_server>("mw3-stun.us.demonware.net");
			udp_servers.create<stun_server>("mw3-stun.eu.demonware.net");
			...
			tcp_servers.create<auth3_server>("mw3-pc-auth.prod.demonware.net");
			tcp_servers.create<lobby_server>("mw3-pc-lobby.prod.demonware.net");
