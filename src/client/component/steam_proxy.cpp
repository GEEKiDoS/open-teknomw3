...
namespace steam_proxy
{
	namespace
	{
		utils::binary_resource runner_file(RUNNER, "opentekno-runner.exe");
	...
	public:
		void post_load() override
		{
			...
			try
			{
				this->start_mod("Open TeknoMW3: "s + game::environment::get_string(), 209660);
			}
